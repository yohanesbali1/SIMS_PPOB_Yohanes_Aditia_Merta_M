    ...
    return (
        <>
            <form action="" autoCapitalize="off" autoCorrect="off" autoComplete="off" onSubmit={handleSubmit(onSubmit)} className="mt-4">
                ...
                <div className="mb-3">
                    <FormInput icon="fa fa-key" register={register("password")} icon_passowrd="fa fa-eye" type={show.password ? "text" : "password"} errors={errors?.password} placeholder="masukan password anda" >
                ...
                <div className="mb-3">
                    <FormInput icon="fa fa-key" register={register("c_password")} icon_passowrd="fa fa-eye" type={show.c_password ? "text" : "password"} errors={errors?.c_password} placeholder="masukan password anda" >
